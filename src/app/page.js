...
export default function Home() {
  ...
  // App & Theme state
  const [colorTheme, setColorTheme] = useState('govt');
  ...
  useEffect(() => {
    ...
    const savedColor = localStorage.getItem('kharcha_color_theme') || 'govt';
      ...
      <div className="gov-top-strip">
        <div className="gov-strip-container">
          <div className="gov-strip-left">
            ...
            <span className="gov-strip-text">GOVERNMENT OF INDIA | NATIONAL FINANCIAL EXPENDITURE PORTAL</span>
          </div>
          <div className="gov-strip-right">
            <span className="gov-secure-badge">🔒 Official Public Accounts Portal</span>
          </div>
        </div>
      ...
      <div className="main-viewport-content">
        ...
        {!currentUser ? (
          <div className="login-container">
            <div className="login-card glass-card gov-card-border">
              ...
              <div className="login-header">
                ...
                <h2>Kharcha Portal</h2>
                <span className="gov-sub-heading">Public Expenditure & Accounts Management</span>
              </div>
              ...
              {authTab === 'signin' ? (
                <form onSubmit={handleSignIn} className="auth-form">
                  ...
                  <button type="submit" className="btn btn-primary btn-block">Sign In to Portal</button>
                </form>
              ) : (
                /* Sign Up Form */
          ...
          <div className="dashboard-container">
            ...
            <header className="floating-navbar glass-card gov-card-border">
            ...
            {/* Date Filter Bar */}
            <nav className="filter-bar glass-card gov-card-border">
            ...
            <main className="expense-list-container">
              ...
              {filteredExpenses.length === 0 ? (
                ...
                <>
                  ...
                  {totalPages > 1 && (
                    <div className="pagination-bar glass-card gov-card-border">
                      <button 
            ...
            <footer className="app-footer gov-footer">
              <p>🇮🇳 Designed for National Expense Audit & Public Accounts</p>
              <small>© 2026 Government of India | Kharcha Portal. All rights reserved.</small>
            </footer>

            {/* FLOATING CHATBOX ADD EXPENSE WIDGET */}
            {isAddModalOpen && (
              <div className="fab-chatbox-card glass-card gov-card-border">
                ...
                <form onSubmit={handleAddExpense}>
                  ...
                  <div className="form-group">
                    <label>Reason / Category Item</label>
                    <input 
                      type="text" 
        ...
        {isDataModalOpen && (
          <div className="modal-overlay" onClick={(e) => e.target.className === 'modal-overlay' && setIsDataModalOpen(false)}>
            <div className="modal-card glass-card gov-card-border">
              <div className="modal-header">
                <h2>Data Audit & Exports</h2>
              ...
              <div className="data-actions-list">
                <button className="data-action-btn" onClick={handleExportCSV}>
                  ...
                  <div className="action-info">
                    <strong>Export CSV Audit Sheet</strong>
                    <small>Download official spreadsheet file</small>
                  </div>
                </button>
                <button className="data-action-btn" onClick={handleExportJSON}>
                  ...
                  <div className="action-info">
                    ...
                    <small>Save full system backup</small>
                  </div>
                </button>
                <button className="data-action-btn" onClick={() => fileInputRef.current?.click()}>
                  ...
                  <div className="action-info">
                    ...
                    <small>Upload official JSON backup file</small>
                  </div>
                </button>
                ...
                <button className="data-action-btn danger-action" onClick={handleClearAll}>
                  ...
                  <div className="action-info">
                    <strong>Clear All Account Data</strong>
                    <small>Delete expense records permanently</small>
                  </div>
                </button>
              </div>
            </div>
        ...
        {/* MODAL: 13 COLOR THEME PICKER */}
        {isThemeModalOpen && (
          <div className="modal-overlay" onClick={(e) => e.target.className === 'modal-overlay' && setIsThemeModalOpen(false)}>
            <div className="modal-card glass-card theme-picker-card gov-card-border">
              <div className="modal-header">
                <h2>Select Portal Theme</h2>
                <button className="close-btn" onClick={() => setIsThemeModalOpen(false)}>&times;</button>
              </div>
              <div className="theme-grid">
                {[
                  { id: 'govt', name: '1. Official Govt Portal 🇮🇳', bg: 'linear-gradient(135deg, #ff9933, #000080, #138808)' },
                  { id: 'indigo', name: '2. Indigo Electric', bg: 'linear-gradient(135deg, #6366f1, #4f46e5)' },
                  { id: 'emerald', name: '3. Emerald Mint', bg: 'linear-gradient(135deg, #10b981, #059669)' },
                  { id: 'cyan', name: '4. Cyber Cyan', bg: 'linear-gradient(135deg, #06b6d4, #0284c7)' },
                  { id: 'purple', name: '5. Royal Violet', bg: 'linear-gradient(135deg, #a855f7, #7e22ce)' },
                  { id: 'amber', name: '6. Sunset Amber', bg: 'linear-gradient(135deg, #f59e0b, #ea580c)' },
                  { id: 'rose', name: '7. Crimson Rose', bg: 'linear-gradient(135deg, #f43f5e, #e11d48)' },
                  { id: 'monochrome', name: '8. Monochrome', bg: 'linear-gradient(135deg, #3f3f46, #09090b)' },
                  { id: 'teal', name: '9. Ocean Teal', bg: 'linear-gradient(135deg, #14b8a6, #0d9488)' },
                  { id: 'nordic', name: '10. Nordic Aurora', bg: 'linear-gradient(135deg, #06b6d4, #8b5cf6)' },
                  { id: 'gold', name: '11. VIP Gold', bg: 'linear-gradient(135deg, #eab308, #ca8a04)' },
                  { id: 'neon', name: '12. Cyber Neon', bg: 'linear-gradient(135deg, #ec4899, #8b5cf6)' },
                  { id: 'coral', name: '13. Soft Coral', bg: 'linear-gradient(135deg, #ff7e5f, #feb47b)' },
                ].map((t) => (
                  <button 
                    key={t.id} 
